...
pub fn main() {
    ...
    let mut app = App::new("interledger")
        ...
        .subcommands(vec![
            SubCommand::with_name("spsp")
                ...
                SubCommand::with_name("settlement-engine")
                    .about("Runs a settlement engine for the Accounting system")
                    .subcommand(SubCommand::with_name("ethereum-ledger")
    ...
    match app.clone().get_matches().subcommand() {
        ...
        ("settlement-engine", Some(matches)) => match matches.subcommand() {
