...
mod tests {
  ...
  mod btp_message {
    ...
    lazy_static! {
      ...
      static ref MESSAGE_1_SERIALIZED: Vec<u8> = hex::decode("060000000217010204746573740002ffff0474657874010568656c6c6f").unwrap();
    }
  ...
  mod btp_response {
    ...
    lazy_static! {
      ...
      static ref RESPONSE_1_SERIALIZED: Vec<u8> = hex::decode("01000000811b010113736f6d65206f746865722070726f746f636f6c0003aaaaaa").unwrap();
    }
  ...
  mod btp_error {
    ...
    fn from_bytes() {
      assert_eq!(
        BtpError::from_bytes(&ERROR_1_SERIALIZED).unwrap(),
        *ERROR_1
      );
    }
